define(function(){
  function BookmarksCompare(){
    this._bookmarks = [];
    this._differentBookmarks = {};
  }
  
  BookmarksCompare.prototype.compare = function(bookmarks){
    this._differentBookmarks = {};
  ...
  BookmarksCompare.prototype._findDifference = function(breadcrumbs, book, index, original){
  ...
  BookmarksCompare.prototype._findDifferentLinks = function(breadcrumbs, book, index, original){
  ...
  BookmarksCompare.prototype._findDifferentLinksForPath = function(breadcrumbs, book, bookOther){
    var diff = [],
  ...
  BookmarksCompare.prototype._getFolder = function(breadcrumbs, book){
    var folder = {
          body: book,
          isNew: false
        };
  ...
  BookmarksCompare.prototype._findNewLinks = function(folder, book){
    var diff = [];
  ...
  BookmarksCompare.prototype._isNewLink = function(folder, url){
    var have = true;
  ...
  BookmarksCompare.prototype._addDifferentFolder = function(breadcrumbs, data){
  ...
  BookmarksCompare.prototype._addDifferentLinks = function(breadcrumbs, links, original){
    var folder = this._differentBookmarks,
  ...
  BookmarksCompare.prototype._cloneData = function(data){
    var newData = {};
